...
public class InsertionAlgorithm1 {
    //The main method.
    public void sort(int[] arr){
        ...
        for(int i=1;i<arr.length;i++){
            ...
            //Move the values which are behind the insertIndex;
            if(insertIndex==i){
                arr[i]=value;
            }else {
    ...
    public static void main(String[] args) {
        InsertionAlgorithm1 insertionAlgorithm1=new InsertionAlgorithm1();
        int [] arr={342};
        System.out.println(InsertionAlgorithm1.findInertIndex(arr,arr.length,45));
        int [] arr1={342,45,56,7667,676};
        insertionAlgorithm1.sort(arr1);
